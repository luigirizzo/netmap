...
typedef struct _MS_FILTER
{
    ...
    // extensions for netmap use
    NDIS_HANDLE			    UserSendNetBufferListPool;	// identified packets generated by netmap
    ...
    BOOLEAN			    readyToUse;			// set during regif
#if DBG
    BOOLEAN                         bIndicating;
#endif
...
DRIVER_DISPATCH FilterInternalDeviceIoControl;
